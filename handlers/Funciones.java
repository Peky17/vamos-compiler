    ...
    public void funciones() {
        ...
        if (!sintactico.lex.equals(")")) {
            while (true) {
                ...
                sintactico.regtabSim(nomIde, new String[] { "P", tipo, "0", "0" }); // Registrar parámetro en la tabla de símbolos
                firma.append(tipo);
        ...
        // Registrar el tipo de retorno de la función en la tabla de símbolos
        sintactico.regtabSim(nombreFuncion, new String[] { "F", tipoRetornoActual, "0", "0" });
